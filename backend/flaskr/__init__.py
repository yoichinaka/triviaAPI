  ...
  '''
    ...
    def create_question():
        ...
        try:
            ...
            question.insert()
            added_id = Question.query.filter(
                Question.question == new_question) .one_or_none().format().get('id')
  ...
  '''
    ...
    def retrieve_quizzes():
        ...
        try:
            ...
            # remove questions in previous questions from the list of questions
            # above
